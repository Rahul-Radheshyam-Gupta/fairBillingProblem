...
arguments_from_console = sys.argv

# Along with script and log file path, atleast one user must be passed
# For Ex. get_billing_detail.py input.txt ALICE99
if len(arguments_from_console) > 2:
    file_path = arguments_from_console[1]
    input_user_list = arguments_from_console[2:]

    # Before opening log file, lets check the file_path is valid or not.
